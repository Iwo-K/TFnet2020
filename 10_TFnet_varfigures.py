...
# %%
LKadata.obs['Klf1_expr'] = LKadata.X[:, LKadata.var.index == 'Klf1'].todense()
...
LKadata.obs['Klf1_expr_pos1_7'] = LKadata.X[:, LKadata.var.index == 'Klf1'].todense()*1.7
...
LKadata.obs['Elane_expr'] = LKadata.X[:, LKadata.var.index == 'Elane'].todense()
...
LKadata.obs['Elane_expr_neg0_5'] = LKadata.X[:, LKadata.var.index == 'Elane'].todense()*-0.5
...
LKadata.obs['Dntt_expr'] = LKadata.X[:, LKadata.var.index == 'Dntt'].todense()
...
LKadata.obs['Dntt_expr_neg1_25'] = LKadata.X[:, LKadata.var.index == 'Dntt'].todense()*-1.25
